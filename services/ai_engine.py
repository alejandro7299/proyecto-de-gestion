...
CRITICAL_KEYWORDS = [
    "motor", "caja", "transmision", "freno", "direccion", "suspension",
...
def _detect_problematic_vehicles(data, top_n=10):
...
def _detect_cost_anomalies(data, z_threshold=2.0):
